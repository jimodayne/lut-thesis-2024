...
% The figure \ref{fig:articleTypeCount} provides a visual representation of the number of articles published in each category. The number of articles devoted to each category is indicated on the y-axis. The x-axis represents the year of publication. The legend indicates the category of each article.

% 

% \begin{figure}[ht]
%     \centering
%     \includegraphics[width=1\linewidth]{figs/paperCate.png}
%     \caption{Number of articles published in each category}
%     \label{fig:articleTypeCount}
% \end{figure}

% Figure \ref{fig:contributionResearchType} illustrates the relationship between contribution type and research type.  Within the Evaluation Research category, the contribution type of "model" is the most prevalent, appearing in 12 articles. This is followed by "method" (3 articles) and "metric" (1 article). In the Solution Proposal category, the "model" contribution type is again the most common, found in 2 articles, with "process" contributing to 1 article. For Validation Research, only 1 article was identified, categorized by the "metric" contribution type.

% \begin{figure}[ht]
%     \centering
%     \includegraphics[width=1\linewidth]{figs/contribution_type_research.png}
%     \caption{Contribution type by research type}
%     \label{fig:contributionResearchType}
% \end{figure}
